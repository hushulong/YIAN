...
package com.graduatedesign.hsl.yian.widgetlibrary;
...
public class CustomFAB extends ImageButton {
    ...
    private void init(AttributeSet attrSet) {
        ...
        try {
            setBgColor(arr.getColor(R.styleable.FAB_bg_color, Color.GRAY));
            setBgColorPressed(arr.getColor(R.styleable.FAB_bg_color_pressed, Color.WHITE));
