 ...
 */
public class ChinesePatentMedicineActivity extends FragmentActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState){
        ...
        try{
            getSupportFragmentManager().beginTransaction().add(R.id.fragment_container,
                    Fragment.instantiate(ChinesePatentMedicineActivity.this, Fragments.ChinesePatentMedicine.getFragment())).commit();
        }catch (Exception e){
            e.printStackTrace();
        }
