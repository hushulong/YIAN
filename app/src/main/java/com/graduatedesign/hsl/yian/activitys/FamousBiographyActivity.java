 ...
 */
public class FamousBiographyActivity extends FragmentActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState){
        ...
        try{
            getSupportFragmentManager().beginTransaction().add(R.id.fragment_container,
                    Fragment.instantiate(FamousBiographyActivity.this, Fragments.FamousBiography.getFragment())).commit();
        }catch (Exception e){
            e.printStackTrace();
        }
