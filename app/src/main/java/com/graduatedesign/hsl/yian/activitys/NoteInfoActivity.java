 ...
 */
public class NoteInfoActivity extends FragmentActivity implements View.OnClickListener{
    ImageView img_back;
    Button add_commit;
    TextView title;
    EditText edit_note;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.bt_save:
                ...
                notes.add(new Note(note_id,1,content,1));
